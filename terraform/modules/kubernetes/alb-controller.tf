#############################################################################
# Kubernetes Module - AWS Load Balancer Controller
#############################################################################
# This file installs the AWS Load Balancer Controller using Helm.
# The controller manages ALB (Application Load Balancer) creation from
...
# Extract OIDC provider ID from the issuer URL
locals {
...
# Trust policy for the Load Balancer Controller
